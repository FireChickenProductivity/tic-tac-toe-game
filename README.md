...
# Retrospective
## What worked well
Defining abstract code for creating message protocols made it much easier to rapidly update the client and server communications. Building a complete testing framework made it much easier to tell if refactoring changes broke anything, which made it far easier to fix bugs and add major changes like the encryption functionality. 
